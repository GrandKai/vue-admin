export default {
    ...
    platId: state => sessionStorage.getItem('platId') ? sessionStorage.getItem('platId') : state.platId,
    menus: state => sessionStorage.getItem('menus') ? JSON.parse(sessionStorage.getItem('menus')) : state.menus,
