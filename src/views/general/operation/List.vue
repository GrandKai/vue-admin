        ...
        <tree-from>
            ...
            <template slot="queryArea">
                <div style="margin-bottom: 10px; text-align: left">
                    ...
                    <el-select v-model="operationForm.platId" placeholder="请选择操作系统" clearable @change="selectChange" ref="select">
            ...
            <template slot="formArea">
                ...
                <el-form :model="operationForm" :rules="operationRules" ref="operationForm" v-show="operationFormIsShow" label-width="100px" status-icon>
                    ...
                    <el-form-item>
                        <el-button type="primary" class="submit" @click="onSubmit('operationForm')">提 交</el-button>
                    </el-form-item>
                </el-form>
                ...
                <el-form :model="permissionForm" :rules="permissionRules" ref="permissionForm"
                    ...
                    <el-form-item>
                        <el-button type="primary" class="submit" @click="onSubmit('permissionForm')">提 交</el-button>
                    </el-form-item>
                </el-form>
            </template>
        </tree-from>
